...
extensionToggle.addEventListener('change', async () => {
    ...
    if (tab?.url?.includes('linkedin.com')) {
        chrome.tabs.sendMessage(tab.id, { type: 'SETTINGS_CHANGED', enabled });
    }
    chrome.runtime.sendMessage({ type: 'SETTINGS_CHANGED', enabled });
...
confirmResetBtn.addEventListener('click', async () => {
    ...
    chrome.runtime.sendMessage({ type: 'RESET_COUNTERS' });
